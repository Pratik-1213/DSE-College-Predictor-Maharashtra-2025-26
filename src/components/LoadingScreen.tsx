...
export default function LoadingScreen({ onComplete }: LoadingScreenProps) {
  ...
  return (
    <div className="w-full max-w-xl mx-auto bg-white border border-slate-200 p-8 rounded-3xl shadow-lg my-12 text-center flex flex-col items-center justify-center min-h-[380px] relative overflow-hidden">
      ...
      <div className="relative w-20 h-20 flex items-center justify-center mb-8">
        ...
        <div className="absolute w-8 h-8 rounded-full bg-primary/10 animate-ping" />
      </div>
